...
LABEL org.opencontainers.image.source="https://github.com/ndndndn1/robot-fleet-telemetry"
RUN apt-get update && apt-get install -y --no-install-recommends curl && rm -rf /var/lib/apt/lists/*
WORKDIR /app
COPY --from=backend-build /workspace/target/robot-fleet-telemetry-1.0.0.jar app.jar
